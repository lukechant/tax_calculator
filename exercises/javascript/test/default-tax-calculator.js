...
let DefaultTaxCalculator = class DefaultTaxCalculator extends TaxCalculator {
  ...
  calculateTax(vehicle) {
    ...
    if (fuelType === "Petrol") {
      ...
      if (co2Emissions === 0) {
        taxAmount = 0;
      } else if (co2Emissions > 0 && co2Emissions <= 50) {
        taxAmount = 25;
      } else if (co2Emissions > 50 && co2Emissions <= 75) {
        taxAmount = 105;
      } else if (co2Emissions > 75 && co2Emissions <= 90) {
        taxAmount = 125;
      } else if (co2Emissions > 90 && co2Emissions <= 100) {
        taxAmount = 145;
      } else if (co2Emissions > 100 && co2Emissions <= 110) {
        taxAmount = 165;
      } else if (co2Emissions > 110 && co2Emissions <= 130) {
        taxAmount = 205;
      } else if (co2Emissions > 130 && co2Emissions <= 150) {
        taxAmount = 515;
      } else if (co2Emissions > 150 && co2Emissions <= 170) {
        taxAmount = 830;
      } else if (co2Emissions > 170 && co2Emissions <= 190) {
        taxAmount = 1240;
      } else if (co2Emissions > 190 && co2Emissions <= 225) {
        taxAmount = 1760;
      } else if (co2Emissions > 225 && co2Emissions <= 255) {
        taxAmount = 2070;
