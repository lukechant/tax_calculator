  ...
  calculateTax(vehicle) {
    ...
    if (vehicle.fuelType === "Petrol") {
      ...
      if (vehicle.co2Emissions === 0) {
        ...
        if (vehicle.co2Emissions === 0) taxAmount = 0;
        else if (vehicle.co2Emissions <= 50) taxAmount = 25;
        else if (vehicle.co2Emissions <= 75) taxAmount = 105;
        else if (vehicle.co2Emissions <= 90) taxAmount = 125;
        else if (vehicle.co2Emissions <= 100) taxAmount = 145;
        else if (vehicle.co2Emissions <= 110) taxAmount = 165;
        else if (vehicle.co2Emissions <= 130) taxAmount = 205;
        else if (vehicle.co2Emissions <= 150) taxAmount = 515;
        else if (vehicle.co2Emissions <= 170) taxAmount = 830;
        else if (vehicle.co2Emissions <= 190) taxAmount = 1240;
        else if (vehicle.co2Emissions <= 225) taxAmount = 1760;
        else if (vehicle.co2Emissions <= 255) taxAmount = 2070;
        else if (vehicle.co2Emissions > 225) taxAmount = 2070;
      }
    return taxAmount;
  }
};
